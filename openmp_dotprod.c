/*
 *	Exemplo de programa para calculo de produto escalar em paralelo, usando OpenMP. Foi baseado em programa passado pela Professora Andrea Schwertner Charão.
 *  
 */
 ...
 */
void dotprod_worker(int offset)
{
   int i, k;
   double *a = dotdata.a;
   double *b = dotdata.b;     
   ...
   for (k = 0; k < dotdata.repeat; k++) {
	...
	//Realiza o controle da condição de corrida
